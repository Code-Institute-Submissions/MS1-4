...
1. As a new customer I want to make a reservation online.

2. As a new customer I want to know about the restaurant concept, history, chef and food.

3. As a new customer I want to see the restaurant's social presence.

4. As an event promoter I want to contact the restaurant about hosting an event there.

5. As a new/returning customer I wish to be notified of upcoming events & stay up to date with the restaurant.
...
8. As a new customer who is allergic to certain foods I want to know what each food item contains.
...
### Acknowledgements
I wish to thank my Code Institute mentor, Precious Ijege for the advice and encouragement on this project.